...
tampilan() {
    ...
    allowed_ips_url="https://raw.githubusercontent.com/Rudi128/project/main/ip"
...
echo ""
clear
REPO="https://raw.githubusercontent.com/Rudi128/project/main/"
start=$(date +%s)
secs_to_human() {
...
memasang_notifikasi_bot() {
  ...
  local izinsc="https://raw.githubusercontent.com/Rudi128/project/main/ip"
  ...
  local CHATID="324500970"
  local KEY="6903848119:AAGn9zxgTdDvoo4oj1n4azvWJXzDAP8w1Rs"
