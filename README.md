...
```
screen -S setup-session bash -c "wget -q https://raw.githubusercontent.com/Rudi128/project/main/install.sh && chmod +x install.sh && ./install.sh; read -p 'Tekan enter untuk keluar...'"
```
Perintah Untuk Update Script
```
wget -q https://raw.githubusercontent.com/Rudi128/project/main/update.sh && chmod +x update.sh && ./update.sh && rm -f update.sh
```
